...
static constexpr auto qt_meta_stringdata_ZN12BudgetDialogE = QtMocHelpers::stringData(
    "BudgetDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12BudgetDialogE[] = {
...
Q_CONSTINIT const QMetaObject BudgetDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12BudgetDialogE.offsetsAndSizes,
    qt_meta_data_ZN12BudgetDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12BudgetDialogE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<BudgetDialog, std::true_type>
    >,
    nullptr
} };
...
void *BudgetDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12BudgetDialogE.stringdata0))
