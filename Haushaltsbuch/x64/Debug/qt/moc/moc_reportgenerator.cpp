...
namespace {
struct qt_meta_tag_ZN15ReportGeneratorE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN15ReportGeneratorE = QtMocHelpers::stringData(
    "ReportGenerator"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15ReportGeneratorE[] = {
...
Q_CONSTINIT const QMetaObject ReportGenerator::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15ReportGeneratorE.offsetsAndSizes,
    qt_meta_data_ZN15ReportGeneratorE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15ReportGeneratorE_t,
        // Q_OBJECT / Q_GADGET
...
void *ReportGenerator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15ReportGeneratorE.stringdata0))
